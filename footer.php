<?php if (!defined('__TYPECHO_ROOT_DIR__')) exit; ?>
  <footer id="footer" class="app-footer" role="footer">
    <div class="wrapper b-t bg-light">
      ...
      <a data-no-instant target="blank" href="http://www.typecho.org">Typecho</a> | <a data-no-instant target="blank" href="https://github.com/ikym/typecho-theme-handsome">handsome</a> | <a data-no-instant target="blank" href="https://www.kdatacenter.com/myportal/?affid=591">Kdatacenter</a> <a onclick="gotoTop()" class="m-l-sm text-muted" data-toggle="tooltip" data-placement="auto left" title="返回顶部"><i class="iconfont icon-longarrowup"></i></a>
      </span><?php $this->options->BottomleftInfo(); ?>
      &copy; 2016 - <?php echo date("Y");?> <a data-no-instant target="blank" href="http://www.mlio.net">CY</a>.
...
(function() {
  ...
  hm.src = "https://hm.baidu.com/hm.js?55eaba2efb322cfc27d6d8c068e98af1";
