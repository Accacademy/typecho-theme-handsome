...
#typecho-option-item-customCss-40,#typecho-option-item-customJs-41{
    ...
    margin-bottom: 10px;
    margin-top: 10px;
    font-size: 16px;">感谢您使用 <a href="https://github.com/ikym/typecho-theme-handsome" target="_blank" style="color:#3384da;font-weight:bold;text-decoration:underline">handsome</a> 主题&emsp; </span>
    </p>';
